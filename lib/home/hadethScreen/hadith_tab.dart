...
import 'package:islami_project/home/hadethScreen/hadeth_details.dart';
...
class _HadithTabState extends State<HadithTab> {
      ...
      children: [
        ...
        :CarouselSlider.builder(
          itemBuilder: (BuildContext context, int index, int realIndex) {
            return InkWell(
              onTap: (){
                Navigator.pushNamed(context, HadethDetailsWidget.routeName,
  ...
  void loadFileHadeth() async {
    for(int i =1 ;i<=50 ;i++) {
      ...
      HadethDetailsModal hadethDetailsModal = HadethDetailsModal(title: title,content:hadethLines,hadethNum: i);
